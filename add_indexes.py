    ...
    try:
        ...
        if 'ix_channel_tags_account_id' not in existing_indexes:
            indexes_to_create.append(
                ("ix_channel_tags_account_id", "CREATE INDEX IF NOT EXISTS ix_channel_tags_account_id ON channel_tags(account_id)")
            )
        ...
        if 'idx_channel_tags_account_tag' not in existing_indexes:
            indexes_to_create.append(
                ("idx_channel_tags_account_tag", "CREATE INDEX IF NOT EXISTS idx_channel_tags_account_tag ON channel_tags(account_id, tag_id)")
            )
