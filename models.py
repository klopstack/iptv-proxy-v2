...
class Filter(db.Model):
    ...
    name = db.Column(db.String(100), nullable=False)
    filter_type = db.Column(db.String(50), nullable=False)  # category, channel_name, regex, country, language
...
class RuleSet(db.Model):
    ...
    # Relationships
    rules = db.relationship('TagRule', backref='ruleset', lazy=True, cascade='all, delete-orphan', 
                           order_by='TagRule.priority')
