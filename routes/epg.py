...
__all__ = ["epg_bp", "_sync_sd_channels_to_epg"]
...
# ============================================================================
# API Routes - EPG Matching (moved to routes/epg/channels.py)
# API Routes - EPG Mappings (moved to routes/epg/channels.py)
# ============================================================================

# Note: The following routes have been moved to routes/epg/channels.py:
# - GET /api/epg/channels - get_epg_channels
# - POST /api/epg/match/<account_id> - match_channels_to_epg
# - POST /api/epg/match-with-rules/<account_id> - match_channels_to_epg_with_rules
# - GET /api/epg/mappings - get_epg_mappings
# - POST /api/epg/mappings - create_epg_mapping
# - DELETE /api/epg/mappings/<mapping_id> - delete_epg_mapping
# - POST /api/epg/mappings/bulk-delete - bulk_delete_epg_mappings
# - POST /api/accounts/<account_id>/epg-source - create_account_epg_source

# ============================================================================
# API Routes - EPG Coverage Stats (moved partially, keeping these for now)
# ============================================================================
