...
def rewrite_hls_manifest(manifest: str, mediaflow_base_url: str, public_proxy_base: str) -> str:
    ...
    Args:
        ...
        public_proxy_base: Client-visible proxy base URL (from get_proxy_base_url)
    ...
    public_base = public_proxy_base.rstrip("/")
    ...
    def rewrite_url(url: str) -> str:
        ...
        if url.startswith(mediaflow_origin):
            ...
            return f"{public_base}{MEDIAFLOW_PASSTHROUGH_PREFIX}{suffix}"
