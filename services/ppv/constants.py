...
# Ambiguous calendar match: minimum confidence gap between best and second match
MATCH_AMBIGUITY_LOW_CONFIDENCE_CUTOFF = 0.5
MATCH_AMBIGUITY_GAP_LOW = 0.2
MATCH_AMBIGUITY_GAP_MEDIUM = 0.15
# Playlist visibility: hide channels/events with title dates beyond this horizon
...
# Channel timezone resolver confidence scores
TIMEZONE_METADATA_ONLY_CONFIDENCE = 0.2
TIMEZONE_FALLBACK_CONFIDENCE = 0.25
