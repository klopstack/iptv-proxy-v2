...
def resolve_channel_timezone(
    ...
    *,
    ...
    if matchup is None and competitors:
        matchup = extractor.extract_matchup(channel_name, category_name=category_name)
...
def resolve_channel_datetime_utc(
    ...
    *,
    ...
    ext = extraction or PPVEventExtractor().extract_all(channel_name, category_name=category_name)
