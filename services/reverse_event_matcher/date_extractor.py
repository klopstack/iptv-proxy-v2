...
class DateExtractor:
    ...
    def __init__(self):
        ...
        # Priority order: ISO dates, then explicit timestamps, then natural language
    ...
    def extract_date(self, channel_name: str) -> Optional[datetime]:
        ...
        3. Search for dates embedded in text (handles natural language)
        ...
        # Strategy 3: Use search_dates to find dates embedded in text
