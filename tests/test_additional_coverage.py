...
class TestTagExtractionEdgeCases:
    ...
    def test_extract_tags_empty_rules(self, app):
        ...
        tags, cleaned, _, _ = TagService.extract_tags("ESPN HD", "Sports", [])
        assert tags == set()
    ...
    def test_extract_tags_callsign_extraction(self, app):
        ...
        with app.app_context():
            ...
            tags, cleaned, _, _ = TagService.extract_tags("ESPN (WABC)", "Sports", [rule])
            assert "WABC" in tags
    ...
    def test_extract_tags_capture_tag(self, app):
        ...
        with app.app_context():
            ...
            tags, cleaned, _, _ = TagService.extract_tags("US| ESPN", "Sports", [rule])
            assert "US" in tags
    ...
    def test_extract_tags_capture_no_group(self, app):
        ...
        with app.app_context():
            ...
            tags, cleaned, _, _ = TagService.extract_tags("ESPN HD", "Sports", [rule])
