"""Tests for full configuration bundle export/import API."""
...
class TestConfigTransferAPI:
    """Validate full configuration export/import behavior."""

    def test_export_bundle_contains_expected_sections(self, app, client):
        """Export returns all core sections with configured records."""
    ...
    def test_import_bundle_creates_configuration(self, app, client):
        """Import creates rulesets, filters, EPG rules, and FCC patterns."""
        bundle = {
    ...
    def test_import_bundle_overwrite_updates_existing(self, app, client):
        """Import with overwrite updates existing named entities instead of skipping."""
        with app.app_context():
