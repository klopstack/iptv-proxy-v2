...
def test_create_tag_rule_with_valid_data(app, client):
    ...
    response = client.post('/api/tag-rules', json={
...
def test_create_playlist_config_with_valid_data(client):
    ...
    response = client.post('/api/playlist-configs', json={
        'name': 'Test Playlist',
        'include_accounts': [1, 2],
...
def test_create_playlist_config_account_overlap(client):
    ...
    response = client.post('/api/playlist-configs', json={
        'name': 'Test Playlist',
        'include_accounts': [1, 2, 3],
        'exclude_accounts': [2, 4]  # 2 overlaps
    })
